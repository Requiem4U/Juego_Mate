...
export class Area_02 extends Phaser.Scene {
    ...
    create () {
        ...
        this.add.image(posicion.x, posicion.y, '_fondo_area_02').setScale(0.855, 0.785).setDepth(-1)
        ...
        this.grupo1 = crearGrupoElementos(this, '_arbol_7', {
            width: 4,
            repeticiones: 4,
        ...
        this.grupo2 = crearGrupoElementos(this, '_arbol_7', {
            width: 4,
            repeticiones: 4,
            posicionX: posicion.x * 0.15,
    ...
    update () {
        ...
        if (this.player.y > 248) {
            this.player.setDepth(2)
            this.grupo2.setDepth(1)
        } else {
            this.player.setDepth(1)
            this.grupo2.setDepth(2)
        }
    }
}