...
export class ver_usuarios extends Phaser.Scene {
    constructor() {
        super({ key: 'ver_usuarios' });
    }
    ...
    create () {
        ...
        this.add.text(774, 180, 'Usuarios', {
            fontSize: '40px',
            fontStyle: 'bold',
            color: '#000000',
        }).setOrigin(0.5);
        ...
        fetch(`${apiUrl}/api/usuarios`)
            ...
            .then(data => {
                ...
                const tableContainer = this.add.dom(500, 210).createElement('div');

                // Crear una tabla
                const table = document.createElement('table');

                // Crear encabezados de la tabla para ID, nombre, contraseña y tipo
                const headers = ['ID', 'Nombre', 'Contraseña', 'Tipo de usuario', ' ', ' '];
                ...
                data.data.forEach(item => {
                    ...
                    img2.onclick = () => {
                        ...
                        fetch(`${apiUrl}/api/usuarios/${rowId}`, {
                            method: 'DELETE',
                            headers: {
                ...
                tableContainer.node.style.height = '450px'; // Altura fija para la tabla
